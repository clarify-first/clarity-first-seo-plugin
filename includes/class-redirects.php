      ...
      <div class="cfseo-card">
          ...
          <table class="form-table">
            ...
            <tr>
              ...
              <td>
                ...
                <p class="description" id="redirect-type-description"><?php _e('Use 301 when the old page is permanently replaced by the new page.', 'clarity-first-seo'); ?></p>
                <script>
                  (function() {
                    const descriptions = {
                      '301': '<?php echo esc_js(__('Use 301 when the old page is permanently replaced by the new page.', 'clarity-first-seo')); ?>',
                      '302': '<?php echo esc_js(__('Use 302 when the redirect is temporary and the original URL may return.', 'clarity-first-seo')); ?>',
                      '307': '<?php echo esc_js(__('Use 307 for temporary redirects that preserve the HTTP method (POST stays POST).', 'clarity-first-seo')); ?>'
                    };
        ...
        <div style="margin-top: 20px; padding: 12px; background: #f0f6fc; border-left: 4px solid #0073aa; border-radius: 4px;">
          <h4 style="margin-top: 0; margin-bottom: 8px; color: #0073aa;">
            ...
            <?php _e('Important Notes', 'clarity-first-seo'); ?>
          </h4>
          <p style="margin: 0; color: #646970; font-size: 13px;">
            <strong><?php _e('Auto vs Manual:', 'clarity-first-seo'); ?></strong> <?php _e('Auto redirects are created automatically by the system (for example, when URLs change). Manual redirects are created explicitly on this page.', 'clarity-first-seo'); ?>
          </p>
        </div>
      </div>
              ...
              <?php foreach ($redirects as $index => $redirect): ?>
                <tr>
                  ...
                  <td>
                    ...
                    <?php else: ?>
                      <span class="dashicons dashicons-admin-tools" title="<?php esc_attr_e('Auto Redirects', 'clarity-first-seo'); ?>"></span> <?php _e('Auto Redirects', 'clarity-first-seo'); ?>
                    <?php endif; ?>
                  </td>
                  <td>
